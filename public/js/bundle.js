      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 9:
            ...
            document.getElementById("spinner").style.display = "none";
            if (_context5.t0.response.data.message.includes("Duplicate field value")) (0, _alert.showAlert)('error', "You are already registered please Login.");
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"cart.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updateC = exports.statusChange = exports.empty_cart = exports.deleteO1 = exports.deleteO = exports.deleteC = exports.confirm = exports.addO = exports.addC = void 0;
...
var updateC = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(id, Quantity) {
    var res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
...
exports.updateC = updateC;

var deleteC = /*#__PURE__*/function () {
...
var deleteO = /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(TransactionID) {
    var res;
    return regeneratorRuntime.wrap(function _callee6$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 9:
            ...
            document.getElementById("spinner").style.display = "none";
            (0, _alert.showAlert)('error', _context6.t0.response.data.message, 3);
  ...
  return function deleteO(_x5) {
    return _ref6.apply(this, arguments);
  };
}();

exports.deleteO = deleteO;

var deleteO1 = /*#__PURE__*/function () {
  var _ref7 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(TransactionID) {
    var res;
    return regeneratorRuntime.wrap(function _callee7$(_context7) {
      while (1) {
        switch (_context7.prev = _context7.next) {
          ...
          case 8:
            ...
            document.getElementById("spinner").style.display = "none";
            (0, _alert.showAlert)('error', _context7.t0.response.data.message, 3);
  ...
  return function deleteO1(_x6) {
    return _ref7.apply(this, arguments);
  };
}();

exports.deleteO1 = deleteO1;

var statusChange = /*#__PURE__*/function () {
  var _ref8 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8(TransactionID) {
    var res;
    return regeneratorRuntime.wrap(function _callee8$(_context8) {
      while (1) {
        switch (_context8.prev = _context8.next) {
          ...
          case 8:
            ...
            document.getElementById("spinner").style.display = "none";
            (0, _alert.showAlert)('error', _context8.t0.response.data.message, 3);
  ...
  return function statusChange(_x7) {
    return _ref8.apply(this, arguments);
  };
}();
...
var confirm = /*#__PURE__*/function () {
  var _ref9 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9(TransactionID) {
    var res;
      ...
      while (1) {
        switch (_context9.prev = _context9.next) {
          ...
          case 8:
            ...
            document.getElementById("spinner").style.display = "none";
            (0, _alert.showAlert)('error', _context9.t0.response.data.message, 3);
...
if (signinform1) signinform1.addEventListener('submit', function (e) {
  ...
  var _iterator = _createForOfIteratorHelper(document.getElementById('acategory').options),
      _step;
  ...
  form.append('shop', document.getElementById('ashop').value); // for (var [key, value] of form.entries()) { 
...
if (aupdate) aupdate.addEventListener('submit', function (e) {
  ...
  var _iterator2 = _createForOfIteratorHelper(document.getElementById('acategory').options),
      _step2;
  ...
  (0, _login.updatea)(form);
});
if (addp) addp.addEventListener('submit', function (e) {
  e.preventDefault();
  var form = new FormData();
...
cboxu.forEach(function (box) {
  box.addEventListener('change', function (e) {
    var id = document.getElementById('proId').value;
    var quantity = document.getElementById('quantity').value;
    if (id != "") (0, _cart.updateC)(id, quantity);
  });
});
var cboxd = document.querySelectorAll(".deletec");
cboxd.forEach(function (box) {
  box.addEventListener('click', function (e) {
    e.preventDefault();
    var id = document.getElementById('proId').value;
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "7133" + '/');
