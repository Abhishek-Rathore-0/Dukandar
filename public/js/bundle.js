...
exports.updateC = exports.deleteC = void 0;
...
var updateC = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(id, Quantity) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
  ...
  return function updateC(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
...
var updatec = document.querySelector('.updatec');
var deletec = document.querySelector('.deletec');
...
if (updatec) updatec.addEventListener('submit', function (e) {
  e.preventDefault();
  var id = document.getElementById('pid').value;
  var quantity = document.getElementById('quantity').value;
  (0, _cart.updateC)(id, quantity);
});
if (deletec) deletec.addEventListener('submit', function (e) {
  e.preventDefault();
  var id = document.getElementById('pid').value;
  (0, _cart.deleteC)(id);
});
